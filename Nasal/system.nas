...
aircraft.light.new("sim/model/Embraer-195/lighting/strobe", [0.05, 1.2], strobe_switch);
beacon_switch = props.globals.getNode("controls/lighting/beacon", 1);
aircraft.light.new("sim/model/Embraer-195/lighting/beacon", [0.05, 1.25], beacon_switch);
...
if(getprop("/sim/model/start-idling")) {
 ...
 setprop("sim/model/Embraer-195/start-engines", 1);
 lengine_running = 1;
 rengine_running = 1;
 ...
 setprop("/sim/model/Embraer-195/n1[0]",0);
 setprop("/sim/model/Embraer-195/n1[1]",0);
 setprop("/sim/model/Embraer-195/n2[0]",0);
 setprop("/sim/model/Embraer-195/n2[1]",0);
 setprop("/sim/model/Embraer-195/egt[0]",0);
 setprop("/sim/model/Embraer-195/egt[1]",0);
};
setprop("/sim/model/Embraer-195/start-cycle[0]",0);
setprop("/sim/model/Embraer-195/start-cycle[1]",0);
setprop("/sim/model/Embraer-195/apu-start",0);
...
cur_n1_l = getprop("/sim/model/Embraer-195/n1[0]");
cur_n1_r = getprop("/sim/model/Embraer-195/n1[1]");
...
if(!getprop("/sim/model/Embraer-195/start-engines") and lengine_running) {
 setprop("/controls/engines/engine/cutoff",1);
};
if(!getprop("/sim/model/Embraer-195/start-engines") and rengine_running) {
 setprop("/controls/engines/engine[1]/cutoff",1);
};

if(!getprop("/controls/engines/engine/cutoff")){
    setprop("/sim/model/Embraer-195/n1[0]",getprop("/engines/engine/n1"));
    setprop("/sim/model/Embraer-195/n2[0]",getprop("/engines/engine/n2"));
    setprop("/sim/model/Embraer-195/egt[0]",getprop("/engines/engine[0]/egt-degf"));
}else{
    setprop("controls/engines/engine/throttle",0);
    interpolate("/sim/model/Embraer-195/n1[0]",0,10);
    interpolate("/sim/model/Embraer-195/n2[0]",0,10);
    interpolate("/sim/model/Embraer-195/egt[0]",0,10);
    if(getprop("/sim/model/Embraer-195/n1[0]") < 5.0){
        lengine_running  = 0;
    }
}

if(!getprop("/controls/engines/engine[1]/cutoff")){
    setprop("/sim/model/Embraer-195/n1[1]",getprop("/engines/engine[1]/n1"));
    setprop("/sim/model/Embraer-195/n2[1]",getprop("/engines/engine[1]/n2"));
    setprop("/sim/model/Embraer-195/egt[1]",getprop("/engines/engine[1]/egt-degf"));
}else{
    setprop("/controls/engines/engine[1]/throttle",0);
    interpolate("/sim/model/Embraer-195/n1[1]",0,10);
    interpolate("/sim/model/Embraer-195/n2[1]",0,10);
    interpolate("/sim/model/Embraer-195/egt[1]",0,10);
    if(getprop("/sim/model/Embraer-195/n1[1]") < 5.0){
        rengine_running  = 0;
    }
}

if(getprop("/sim/model/Embraer-195/start-cycle[0]") and (apu_running or (getprop("/sim/model/Embraer-195/n1[0]") > 35.0))) {
    interpolate("/sim/model/Embraer-195/n1[0]",56.0,10);
    interpolate("/sim/model/Embraer-195/n2[0]",70.0,10);
    interpolate("/sim/model/Embraer-195/egt[0]",60.0,10);
    if(getprop("/sim/model/Embraer-195/n1[0]") > 55.0) {
        setprop("/sim/model/Embraer-195/start-cycle[0]",0);
...
if(getprop("/sim/model/Embraer-195/start-cycle[1]") and (apu_running or (getprop("/sim/model/Embraer-195/n1[1]") > 35.0))) {
    interpolate("/sim/model/Embraer-195/n1[1]",56.0,10);
    interpolate("/sim/model/Embraer-195/n2[1]",70.0,10);
    interpolate("/sim/model/Embraer-195/egt[1]",60.0,10);
    if(getprop("/sim/model/Embraer-195/n1[1]") > 55.0) {
        setprop("/sim/model/Embraer-195/start-cycle[1]",0);
...
if(getprop("/sim/model/Embraer-195/start-cycle[0]") and !apu_running) {setprop("/sim/model/Embraer-195/start-cycle[0]",0);};
if(getprop("/sim/model/Embraer-195/start-cycle[1]") and !apu_running) {setprop("/sim/model/Embraer-195/start-cycle[1]",0);};
...
if(!getprop("/controls/engines/engine[2]/cutoff")){
    setprop("/sim/model/Embraer-195/apu-n1",getprop("/engines/engine[2]/n1"));
    setprop("/sim/model/Embraer-195/apu-n2",getprop("/engines/engine[2]/n2"));
    setprop("/sim/model/Embraer-195/apu-egt",getprop("/engines/engine[2]/egt-degf"));
}else{
    setprop("controls/engines/engine[2]/throttle",0);
    interpolate("/sim/model/Embraer-195/apu-n1",0,10);
    interpolate("/sim/model/Embraer-195/apu-n2",0,10);
    interpolate("/sim/model/Embraer-195/apu-egt",0,10);
    if(getprop("/sim/model/Embraer-195/apu-n1") < 50.0){
        apu_running  = 0;
    }
}
if(getprop("/sim/model/Embraer-195/apu-start")) {
    interpolate("/sim/model/Embraer-195/apu-n1",80.0,4);
    interpolate("/sim/model/Embraer-195/apu-n2",85.0,4);
    interpolate("/sim/model/Embraer-195/apu-egt",350.0,4);
    if(getprop("/sim/model/Embraer-195/apu-n1") > 79.8){
        setprop("/sim/model/Embraer-195/apu-start",0);
...
if(getprop("/controls/APU/off-start-run")==1 and getprop("/systems/electrical/outputs/starter")>20) {
  if(!getprop("/sim/model/Embraer-195/apu-start")) {
    ...
    if(getprop("/systems/electrical/apu-test")<0.1) {setprop("/sim/model/Embraer-195/apu-start",1);};
  }
}
if(getprop("/controls/APU/off-start-run")==1 and getprop("/systems/electrical/outputs/starter")<20) {
